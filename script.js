...
if (whatsappBtn) {
    whatsappBtn.addEventListener('click', () => {
        ...
        const message = `Hello Jenz Pickles, I want to order Mango Pickle (മാങ്ങ അച്ചാർ).%0AQuantity: ${selectedQuantity}%0APrice: ₹${msgPrice}%0ADelivery Charge: ₹${deliveryCharge}%0ATotal Price: ₹${totalPrice}`;
